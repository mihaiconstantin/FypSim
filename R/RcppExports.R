...
#' @export
#' 
runCell <- function(shift_proportion, shift_magnitude, shift_type, parameters_type, test_length) {
    .Call('FypSim_runCell', PACKAGE = 'FypSim', shift_proportion, shift_magnitude, shift_type, parameters_type, test_length)
}
...
#' @export
#'
runSelectedCells <- function(selected_cells) {
